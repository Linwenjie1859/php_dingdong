...
//        return $this->fetch('public/common_form');
        $field = [
            ...
            Form::input('author','作者名字')->placeholder('请输入作者名字')->col(8),
            Form::input('press','出版社')->placeholder('请输入出版社名')->col(8),
    ...
    public function save(Request $request)
    {
        ...
        if(!$data['author']) return Json::fail('请输入作者名称');
        if(!$data['press']) return Json::fail('请输入出版社名称');
    ...
    public function edit($id)
    {
        ...
        $field = [
            ...
            Form::input('author','作者名字',$product->getData('author'))->placeholder('请输入作者名字')->col(8),
            Form::input('press','出版社',$product->getData('press'))->placeholder('请输入出版社名')->col(8),
